...
<script>
	...
	export default {
		data() {
			return {
				host: "http://www.charlie.technolog.blog", //api接口
				show: false, //显示页面
        		loading:"数据加载中...",
		...
		created: function(){
		   ...
		   var self = this;
			...
			//api根地址
            if(document.domain=="127.0.0.1" || document.domain=="localhost" || document.domain=="www.charlie.technolog.blog"){ //webpack环境下
                this.host = "http://www.charlie.technolog.blog";
            }else{
                this.host = "http://charlie-chen.gz01.bdysite.com"; //正式上线
            }
